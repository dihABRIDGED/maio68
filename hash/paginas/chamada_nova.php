...
require_once "../inclusos/conexao.php"; // Adjusted path
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["action"]) && $_POST["action"] === "register_attendance") {
    ...
    try {
        ...
        $sql_alunos_disciplina_para_aula = "SELECT id FROM usuario WHERE tipo = 'aluno'";
...
if ($selected_disciplina_id) {
    // Get ALL students
    $sql_alunos_disciplina = "SELECT id, nome FROM usuario WHERE tipo = 'aluno' ORDER BY nome";
        ...
        <div id="professorView" class="view-section active">
            <div class="chamada-container">
                <div class="step-card panel">
                    ...
                    <form method="GET" action="chamada_nova.php">
                ...
                <div class="step-card panel">
                    ...
                    <form method="POST" action="chamada_nova.php">
