        ...
        switch ($_POST['action']) {
            case 'create':
                ...
                if ($stmt->fetchColumn() > 0) {
                    $error_message = 'Login ou email já existem!';
                    break; 
                }
                
                $stmt = $pdo->prepare("INSERT INTO Usuario (nome, email, tipo, login, senha, ativo, tema) VALUES (?, ?, ?, ?, ?, 1, ?)");
                $stmt->execute([$nome, $email, $tipo, $login, $senha, '0']);
...
<div id="createModal" class="modal">
    <div class="modal-content">
        ...
        <form id="createForm" method="POST" action="usuarios.php">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="senha" id="create_senha" required>
                </div>
            </div>
    ...
    document.getElementById('editForm').addEventListener('submit', function(e) {
	    ...
	    function submitForm(formData, modalId) {
	        fetch('usuarios.php', {
	            ...
	            body: 'ajax=1&' + new URLSearchParams(formData).toString()
	        })
	        .then(response => response.json())
	        .then(data => {
	            if (data.success) {
