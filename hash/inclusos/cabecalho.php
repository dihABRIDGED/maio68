...
<body>
    <header class="header">
        ...
        <!-- Navegação principal -->
        <nav class="nav">
            <a href="inicio.php" class="nav-link <?php echo $current_page === 'inicio.php' ? 'active' : ''; ?>">
            ...
            <div class="user-dropdown">
                ...
                <div class="user-dropdown-menu" id="userDropdown">
                    ...
                    <hr>
                    <a href="../inclusos/saida.php" class="dropdown-item logout">
        ...
        <div class="mobile-menu" id="mobileMenu">
            ...
            <nav class="mobile-nav">
                <a href="inicio.php" class="mobile-nav-link <?php echo $current_page === 'inicio.php' ? 'active' : ''; ?>">
                <i class="fas fa-home"></i>
                Início
            </a>
            ...
            <?php else: // coordenador ?>
                ...
                <a href="relatorios.php" class="mobile-nav-link <?php echo $current_page === 'relatorios.php' ? 'active' : ''; ?>">
                    <i class="fas fa-chart-bar"></i>
                    Relatórios
                </a>
            <?php endif; ?>
            ...
            <a href="../inclusos/saida.php" class="mobile-nav-link logout">
                <i class="fas fa-sign-out-alt"></i>
                Sair
            </a>
</nav>
